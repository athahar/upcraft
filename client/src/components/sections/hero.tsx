    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          >Tools got better. Building got faster. But building what's actually worth building is still hard. It requires getting out of your assumptions and into the reality of the people you're building for. For 15 years, we've helped teams do exactly that, while creating category-defining products.</motion.p>
